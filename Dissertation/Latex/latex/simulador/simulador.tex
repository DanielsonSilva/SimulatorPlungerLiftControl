...
A figura \ref{Fig:strategy} representa um diagrama UML de classes. Neste diagrama são apresentados 5 classes distintas: Contexto, Interface comum, Controlador 1, Controlador 2 e Controlador 3. As classes Controlador 1, Controlador 2 e Controlador 3 mantêm um relacionamento de generalização com a classe Interface Comum, ou seja, cada classe de Controlador deve implementar a mesma classe Interface Comum de formas distintas. A relação entre a classe Contexto e Interface Comum é representada por uma agregação unidirecional, mostrando que a classe Contexto possui e utiliza a classe Interface Comum, podendo instanciar qualquer classe de controlador como uma classe Interface Comum \cite{booch}.
