...
\usepackage{multirow}
% pintar células de tabelas de uma certa cor
%\usepackage[table]{xcolor}
% deixar as células de uma tabela centralizadas com largura fixa
\usepackage{array}
...
% Cap. 2 - Plunger Lift
\include{plungerlift/plungerlift}

% Cap. 3 - Simulador
\include{simulador/simulador}

% Cap. 4 - Validação
\include{validacao/validacao}
...
% Adicionar todas as bibliografias
%\nocite{*}
%Referências que faltam: lennedyCampos(não tem a ver)
%TODO: Colocar alguns tipos de pistões pelo artigo do fergurson
%TODO: Colocar performance de pistão no trabalho citando Mower
%TODO: Colocar fergurson2 para o custo do método e gasto das peças
%TODO: Citar davidcosby sobre mais benefícios do uso do método
