...
import controller.CasingPressureController;
import controller.Controller;
import controller.NoController;
...
public class SimulationThread implements Runnable {
	...
	public Map<String, Double> requirePoint() {
		...
		point.put("PtbgT", f.varSaida.PtbgT);// Pressão no topo da coluna de
												// produção
	 ...
	 */
	public void setInitialCondition(Map<String, Double> variables, int type) {
		Entities f = Entities.getInstance();
		DataConstants c = DataConstants.getInstance();
		...
		case 1:
			...
			controllerVariables.put("value", variables.get("value"));
			controllerVariables.put("lowPlungerTime", variables.get("lowPlungerTime"));
			controllerVariables.put("highPlungerTime", variables.get("highPlungerTime"));	
			break;
		// Casing Pressure Controller
		case 2:
			this.control = new CasingPressureController();
			controllerVariables.put("value", variables.get("value"));
			controllerVariables.put("lowPlungerTime", variables.get("lowPlungerTime"));
			controllerVariables.put("highPlungerTime", variables.get("highPlungerTime"));
			controllerVariables.put("lowCasingPressure", variables.get("lowCasingPressure"));
			controllerVariables.put("highCasingPressure", variables.get("highCasingPressure"));
			break;
		// No Controller
		case 3:
			this.control = new NoController();
			break;
		default:
			break;
		}
		this.control.setVariables(controllerVariables);
		...
		f.valvula.Dab = Math.round(conv.inchToMm(variables.get("motorvalveDiameter")) * 100)/100D;
		...
		/*
		 * TimeStepsData samplingData ; samplingData.slugLiftTimeStep =
		 * editSampSlugLift->getFloat() /1000.0;
		 * samplingData.slugProductionTimeStep= editSampSlugProd->getFloat()
		 * /1000.0; samplingData.afterflowTimeStep = editSampAfter->getFloat()
		 * /1000.0; samplingData.buildupTimeStepGas =
		 * editSampBuildupGas->getFloat() /1000.0;
		 * samplingData.buildupTimeStepGasLiq =
		 * editSampBuildupGasLiq->getFloat()/1000.0;
		 * samplingData.buildupTimeStepLiq = editSampBuildupLiq->getFloat()
		 * /1000.0;
		 */
		...
		/*
		 * System.out.println("01 :" + f.fluido.BSW); System.out.println("02 :"
		 * + f.fluido.APi); System.out.println("03 :" + f.fluido.SGagua);
		 * System.out.println("04 :" + f.fluido.SGgas); System.out.println(
		 * "05 :" + f.fluido.GAMA); System.out.println("06 :" +
		 * f.tubing.Lcauda); System.out.println("07 :" + f.tubing.E);
		 * System.out.println("08 :" + f.tubing.DItbg); System.out.println(
		 * "09 :" + f.tubing.DOtbg); System.out.println("10 :" + f.tubing.peso);
		 * System.out.println("11 :" + f.casing.comprimento);
		 * System.out.println("12 :" + f.casing.rugosidade); System.out.println(
		 * "13 :" + f.casing.DIcsg); System.out.println("14 :" +
		 * f.casing.DEcsg); System.out.println("15 :" + f.casing.peso);
		 * System.out.println("16 :" + f.linhaPro.Psep); System.out.println(
		 * "17 :" + f.valvula.Dab); System.out.println("18 :" + f.pistao.Mplg);
		 * System.out.println("19 :" + f.pistao.EfVed); System.out.println(
		 * "20 :" + f.pistao.Lplg); System.out.println("21 :" + f.pistao.Dplg);
		 * System.out.println("22 :" + f.reservat.Pest); System.out.println(
		 * "23 :" + f.reservat.Pteste); System.out.println("24 :" +
		 * f.reservat.Qteste); System.out.println("25 :" + f.reservat.RGL);
		 * System.out.println("26 :" + c.step); System.out.println("27 :" +
		 * c.step_); System.out.println("28 :" + c.step_aft);
		 * System.out.println("29 :" + c._stepGas); System.out.println("30 :" +
		 * c._stepGas2Liq); System.out.println("31 :" + c._stepLiq);
		 * System.out.println("32 :" + f.tempos.Lslg); System.out.println("33 :"
		 * + f.tempos.PcsgT); System.out.println("34 :" + f.tempos.Ontime);
		 * System.out.println("35 :" + f.tempos.Offtime); System.out.println(
		 * "36 :" + f.tempos.Afterflow);
		 */
	}
