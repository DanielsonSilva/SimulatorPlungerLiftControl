...
public class SimulationThread implements Runnable {
	...
	/** Variável de impressão do arquivo das variáveis */
	PrintWriter writer;
	...
	public Map<String,Double> requirePoint() {
		...
		point.put("PcsgB", f.varSaida.PcsgB);//Press�o na base do anular
		point.put("PcsgT", f.tempos.PcsgT);//Press�o no topo do anular
