...
public class InitialCondition {
	...
	private InitialCondition() {
		...
		variables.put("lowPlungerTime", 0.0);
		variables.put("highPlungerTime", 0.0);
		variables.put("value", 0.0);
		variables.put("lowCasingPressure", 0.0);
		variables.put("highCasingPressure", 0.0);
		typeController = 0;
	}

	public void Insert(double[] v, int type) {
		// Tubing variables
		...
		switch (type) {
		case 1:
			variables.put("lowPlungerTime", v[42]);
			variables.put("highPlungerTime", v[43]);
			variables.put("value", v[44]);
			break;
		case 2:
			variables.put("lowPlungerTime", v[42]);
			variables.put("highPlungerTime", v[43]);
			variables.put("value", v[44]);
			variables.put("lowCasingPressure", v[45]);
			variables.put("highCasingPressure", v[46]);
			break;
		case 3:
			break;
		default:
	...
	/**
	 * @return Type of the controller chosen
	 */
